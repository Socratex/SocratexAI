    ...
    "content": {
        ...
        "feature_contracts": {
            ...
            "shared_script_parity_audit": {
                ...
                "known_failure_if_missing": "Root project tools and embedded source tools can silently diverge after PowerShell-to-Python migration, recreating duplicated helper/script behavior that later fixes must repair twice."
            },
            "managed_pipeline_root_catalog_sync": {
