...
~~~json
{
    ...
    "content": {
        "features": [
            ...
            "gpt_conversation_ingestion_tools"
        ],
        "feature_contracts": {
            "adapter_pack_bootstrap": {
            ...
            "script_first_execution": {
                ...
                "promotion_checklist": [
                    "Port the reusable source artifacts, not only the feature id.",
                    "List every required script, document, template, catalog entry, and generated-context input in this contract.",
                    "Keep tool_handler.py parameterized by repo root and tool directory so child projects can delegate through thin adapters instead of copying dispatcher logic.",
                    "Run the feature contract checker before promoting or publishing the update.",
                    "Run managed package sync or reinitialization so child projects receive source-owned artifacts."
                ],
                "verification_commands": [
            ...
            "git_batch_finishers": {
                ...
                "promotion_checklist": [
                    ...
                    "Finalizers must stage diff-derived paths with `git add -A -- <paths>` so deleted and renamed files are included during legacy shell-to-Python package syncs.",
                    "Finalizers must not restage already-staged deletions whose paths no longer exist in the index or worktree.",
                    "Run the feature contract checker before promoting or publishing the update.",
                    "Run managed package sync or reinitialization so child projects receive source-owned artifacts."
                ],
                "verification_commands": [
                    "python3 -B tools/quality/check_python_syntax.py tools/repo/finalize_task_check_commit_push.py tools/repo/finalize_changed_files_commit_push.py tools/repo/run_final_task_checks.py",
            ...
            "portable_json_tooling_pack": {
                ...
                "promotion_checklist": [
                    ...
                    "Keep normalize_json_files.py compatible with both positional glob inputs and repeated --path inputs used by task finalizers for scoped normalization."
                ],
                "verification_commands": [
                    "python3 tools/json/smoke_json_tools.py",
            ...
            "managed_pipeline_package_mirror_sync": {
                ...
                "promotion_checklist": [
                    ...
                    "Run the feature contract checker before promoting or publishing the update.",
                    "Run managed package sync or reinitialization so child projects receive source-owned artifacts.",
                    "Keep license, NOTICE, README, public bootstrap, and managed package path lists aligned so child updates receive current legal/distribution metadata."
                ],
                "verification_commands": [
                    "python3 -B tools/repo/check_pipeline_feature_contracts.py",
                    "python3 -B tools/documents/audit_docs.py",
                    "python3 -B tools/pipeline/update_pipeline_from_link.py --source . --source-mode LocalPath --target-path <child-project> --dry-run"
                ],
            ...
            "shared_script_parity_audit": {
                "summary": "Audit project root tools against embedded SocratexAI tools so same-name or same-relative script pairs stay copied, thinly delegated, or explicitly visible as drift.",
                "required_paths": [
                    "tools/repo/shared_script_parity.py",
                    "SCRIPTS.json",
                    "pipeline_featurelist.json"
                ],
                "required_scripts": [
                ...
                "verification_commands": [
                    "python3 -B tools/repo/shared_script_parity.py --project-root <child-project> --write-report /tmp/socratex-shared-script-parity.json",
                    "python3 -B tools/repo/check_pipeline_feature_contracts.py"
                ],
                "known_failure_if_missing": "Root project tools and embedded source tools can silently diverge after legacy-runtime migration, recreating duplicated helper/script behavior that later fixes must repair twice."
            },
            "managed_pipeline_root_catalog_sync": {
            ...
            "cheap_idempotent_pipeline_update": {
                ...
                "promotion_checklist": [
                    ...
                    "Keep license, NOTICE, README, public bootstrap, and managed package path lists aligned so cheap Git updates receive current legal/distribution metadata."
                ],
                "verification_commands": [
            ...
            "pipeline_sweep_upgrade_tool": {
                ...
                "required_paths": [
                    ...
                    "tools/chains/child_sync_smoke.py",
                    "tools/chains/context_bootstrap_load.py",
                    "tools/chains/final_runtime_gate.py",
                    "tools/chains/no_legacy_shell_verification.py",
                ...
                "promotion_checklist": [
                    ...
                    "Keep catalogued CLI aliases such as -Config, -Project, -Execute, -Smoke, and -WriteReport wired to the Python argparse interface.",
                    "Run Python child commands with -B so sweep and chain tools do not create bytecode cache artifacts outside finalizers.",
                    ...
                    "Use named chain tools for repeated command groups so agents can run documented series instead of reconstructing command batches by memory.",
            ...
            "pipeline_chain_error_contract": {
                ...
                "known_failure_if_missing": "Pipeline failures degrade into ad hoc console traces, so future agents cannot cheaply tell which command failed, where it ran, whether it was required, or what recovery path to take."
            },
            "legacy_feature_manifest_update_recovery": {
            ...
            "helper_enforced_contracts": {
                ...
                "promotion_checklist": [
                    ...
                    "Keep project-facing diagnostics, embedded-config, and quality-fix tools parameterized for child repo roots, log paths, startup markers, required resource sets, generated output locations, and project-specific quality helper entry points.",
                    "List every required script, document, template, catalog entry, and generated-context input in this contract.",
                    "Run the feature contract checker before promoting or publishing the update.",
                    "Run managed package sync or reinitialization so child projects receive source-owned artifacts."
                ],
            ...
            "cross_platform_tool_runtime_resolution": {
                "summary": "Python wrappers resolve the project Python runtime through a parameterized shared runtime helper so source and installed pipeline tools run on Windows, Linux, and Steam Deck/Linux without hardcoded Windows-only Python paths.",
                "required_paths": [
                    "SCRIPTS.json",
                    "pipeline_featurelist.json",
            ...
            "directive_hierarchy_context_budget": {
                ...
                "promotion_checklist": [
                    ...
                    "Keep tier reports/checks backend-explicit: `documents` scans source JSON directly, `knowledge_files` and `sqlite` read compiled caches, and `auto` prefers current SQLite then file fallback then source documents.",
                    "Do not require SQLite just to validate tier coverage in a lightweight installed project.",
                ...
                "verification_commands": [
                    ...
                    "python3 -B tools/knowledge/knowledge_tier_check.py -IncludeTemplates -Backend documents",
                    "python3 -B tools/knowledge/knowledge_tier_check.py -Backend auto"
                ],
            ...
            "script_runtime_retirement_gate": {
                ...
                "promotion_checklist": [
                    ...
                    "Run the gate in source and child repositories after active automation references are migrated; default scope should ignore generated, vendored, cache, prompt-history, audit-history, and changelog-history paths so final verification is not blocked by archival text.",
                ...
                "verification_commands": [
                    ...
                    "python3 -B tools/quality/check_python_syntax.py --repo-root . tools/quality/script_runtime_gate.py tools/pipeline/sync_managed_pipeline_package.py",
            ...
            "public_portfolio_release_metadata": {
                "summary": "Public release positioning, version metadata, starter configuration defaults, and changelog defaults stay aligned for published SocratexPipeline adoption.",
                "required_paths": [
                    "pipeline_featurelist.json",
                    "README.md",
                    "VERSION",
                ...
                "sync_direction": "source_to_child",
                "promotion_checklist": [
                    "Keep README positioning, VERSION, changelog defaults, initializer defaults, import defaults, and starter PIPELINE-CONFIG version in one release change.",
                    "Keep public bootstrap URLs concrete before public publication.",
                    "Keep source release metadata mirrored by managed package sync so child projects can update from Git without manual version patching.",
                    "Run feature contracts, document audit, and final task checks before publishing or tagging the release."
                ],
                "verification_commands": [
                    "python3 -B tools/repo/check_pipeline_feature_contracts.py",
                    "python3 -B tools/documents/audit_docs.py",
                    "python3 -B tools/repo/finalize_task_check_commit_push.py --message \"Prepare public release metadata\""
                ],
                "known_failure_if_missing": "A public release can advertise one version or bootstrap path while newly initialized or imported projects receive stale pipeline metadata."
            },
            "managed_package_source_filter_and_unicode_paths": {
                "summary": "Managed package sync copies only source-managed files, excludes gitignored local snapshots, preserves Python-first package runtime, and decodes Git paths as UTF-8 for non-ASCII workspace roots.",
                "required_paths": [
                    "pipeline_featurelist.json",
                    "tools/pipeline/sync_managed_pipeline_package.py",
                    "tools/shared/repo_helpers.py",
                ...
                "sync_direction": "source_to_child",
                "promotion_checklist": [
                    "Use source git-tracked plus untracked-nonignored files as the package file universe so ignored local reference folders are never copied into child SocratexAI installs.",
                    "Keep obsolete managed package files pruned during child updates, including retired shell-runtime snapshots and generated cache files.",
                    "Decode Git stdout as UTF-8 so repo root discovery works in non-ASCII workspace paths.",
                    "Keep generated compiled instruction cleanup tolerant of Windows/OneDrive read-only directory attributes.",
                    "Configure UTF-8 stdio for task-flow audit output so emoji/context headings do not break finalization on legacy consoles.",
                    "Do not require source-package template checks for child project roots that have project tools but are not SocratexAI package roots.",
                    "Run feature parity, script runtime gate, sensitive leak check, document audit, compiled context checks, and child sweep after promotion."
                ],
                "verification_commands": [
                    "python3 -B tools/quality/check_python_syntax.py --repo-root . tools/pipeline/sync_managed_pipeline_package.py tools/shared/repo_helpers.py tools/pipeline/rebuild_ai_compiled_context.py tools/repo/task_flow_audit.py tools/json/audit_json_docs.py tools/repo/check_sensitive_reference_leaks.py tools/repo/run_final_task_checks.py",
                    "python3 -B tools/quality/script_runtime_gate.py --max-examples 20",
                    "python3 -B tools/repo/check_sensitive_reference_leaks.py",
                    "python3 -B tools/repo/check_pipeline_feature_contracts.py",
                    "python3 -B tools/documents/audit_docs.py",
            ...
            "gpt_conversation_ingestion_tools": {
                "summary": "ChatGPT conversation ingestion tools extract public shared conversations and search/read explicit local private exports or caches before the agent consumes the content.",
                "required_paths": [
                    "tools/adapters/gpt_conversation_core.py",
                    "tools/adapters/gpt_shared_conversation_extract.py",
                    "tools/adapters/gpt_conversation_archive.py",
                    "adapters/gpt_shared_conversation_extract.py",
                    "adapters/gpt_conversation_archive.py",
                    "tools/pipeline/tool_handler.py",
                    "SCRIPTS.json",
                    "WORKFLOW.json"
                ],
                ...
                "sync_direction": "source_to_child",
                "promotion_checklist": [
                    "Keep public share extraction separate from local private export/cache reading.",
                    "Do not add live private account scraping or session-cookie handling to this feature.",
                    "Preserve Markdown/emoji/table/code-block text without lossy rewriting.",
                    "Expose both scripts through SCRIPTS.json and tool_handler aliases.",
                    "Verify syntax plus a local fixture or public share extraction before promotion."
                ],
                "verification_commands": [
                    "python3 -B tools/quality/check_python_syntax.py --repo-root . tools/adapters/gpt_conversation_core.py tools/adapters/gpt_shared_conversation_extract.py tools/adapters/gpt_conversation_archive.py adapters/gpt_shared_conversation_extract.py adapters/gpt_conversation_archive.py tools/pipeline/tool_handler.py",
                    "python3 -B tools/repo/check_pipeline_feature_contracts.py --repo-root .",
                    "python3 -B tools/documents/audit_docs.py"
                ],
                "known_failure_if_missing": "Agents waste context on raw ChatGPT share HTML or whole private exports, or attempt brittle/private live-account scraping instead of extracting a compact conversation artifact first."
            }
        }
    },
    "metadata": {
