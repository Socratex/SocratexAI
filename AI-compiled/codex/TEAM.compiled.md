...
```json
{
    ...
    "content": {
        ...
        "prioritize_sections": {
            "first": [
                "WORKFLOW.json:active_pain_points",
                "STATE.json or STATE.md",
                "_PLAN.json or _PLAN.md",
                "TODO.json or BACKLOG.md",
                "DECISIONS.json or DECISIONS.md"
            ],
            "then": [
            ...
            "avoid": [
                "CHANGELOG.json unless shipped history is directly relevant",
    ...
    "metadata": {
        ...
        "title": "Product",
        "role": "Installed product role lens template."
    }
}
```
...
```json
{
    ...
    "content": {
        ...
        "prioritize_sections": {
            "first": [
                ...
                "DECISIONS.json or DECISIONS.md",
                "_PLAN.json or _PLAN.md",
                "project/code/WORKFLOW.json when installed"
            ],
            "then": [
                "TODO.json or BACKLOG.md",
                "WORKFLOW.json when priority steering matters"
            ],
            "avoid": [
    ...
    "metadata": {
        "schema": "socratex-data-document/v1",
        "title": "Technical",
        "role": "Installed technical role lens template."
    }
}
```
...
```json
{
    ...
    "content": {
        ...
        "prioritize_sections": {
            "first": [
                "WORKFLOW.json active pain points related to performance or scale",
                "STATE.json or STATE.md",
                "diagnostics, benchmark, trace, or log summaries",
                "context-docs/ technical capsules"
            ],
            "then": [
                "BUGS.json or ISSUES.md",
                "_PLAN.json or _PLAN.md",
                "DECISIONS.json or DECISIONS.md"
            ],
            "avoid": [
    ...
    "metadata": {
        "schema": "socratex-data-document/v1",
        "title": "Performance",
        "role": "Installed performance role lens template."
    }
}
```
...
```json
{
    ...
    "metadata": {
        "schema": "socratex-data-document/v1",
        "title": "Experience",
        "role": "Installed experience role lens template."
    }
}
```
...
```json
{
    ...
    "content": {
        ...
        "red_flags": [
            "New process rules without DOCS.json or workflow routing.",
    ...
    "metadata": {
        "schema": "socratex-data-document/v1",
        "title": "Pipeline",
        "role": "Installed pipeline role lens template."
    }
}
```
