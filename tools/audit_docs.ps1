...
try {
    ...
    Test-ContainsText -Text $publicBootstrap -Needle "ACTIVATION-CHECK.md" -Label "PUBLIC-BOOTSTRAP.md"
    ...
    Test-ContainsText -Text $activationCheck -Needle "Required Checks" -Label "core/ACTIVATION-CHECK.md"
    Test-ContainsText -Text $activationCheck -Needle "communication format" -Label "core/ACTIVATION-CHECK.md"
    Test-ContainsText -Text $activationCheck -Needle "emoji rule" -Label "core/ACTIVATION-CHECK.md"
