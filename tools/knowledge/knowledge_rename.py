#!/usr/bin/env python3
"""Rename a source document path in the SQLite knowledge index."""
...
def main() -> int:
    ...
    if not old_path or not new_path:
        parser.error("knowledge_rename.py requires --old-path and --new-path")
    return run_index(resolved_repo_root(args.repo_root), "rename", ["--old-path", old_path, "--new-path", new_path])
