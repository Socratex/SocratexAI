...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--tags", "-Tags", nargs="*", default=[])
    parser.add_argument("--match", "-Match", choices=["all", "any"], default="all")
    parser.add_argument("--type", "-Type", default="")
    parser.add_argument("--view", "-View", default="")
    parser.add_argument("--load-at-start", "-LoadAtStart", action="store_true")
    parser.add_argument("--context-tier", "-ContextTier", action="append", default=[])
    parser.add_argument("--max-context-tier", "-MaxContextTier", type=int, default=0)
    parser.add_argument("--source-path", "-SourcePath", default="")
    parser.add_argument("--document-path", "-DocumentPath", default="")
    parser.add_argument("--name", "-Name", default="")
    parser.add_argument("--file-fallback", "-FileFallback", action="store_true")
