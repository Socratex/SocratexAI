...
def main() -> int:
    ...
    parser.add_argument("--managed-paths", nargs="*", default=DEFAULT_MANAGED_PATHS)
    parser.add_argument("--child-generated-paths", nargs="*", default=DEFAULT_CHILD_GENERATED_PATHS)
    parser.add_argument("--protected-paths", nargs="*", default=DEFAULT_PROTECTED_PATHS)
    parser.add_argument("--apply-project-profile", action="store_true")
    parser.add_argument("--prune-unmanaged", action="store_true")
