...
. (Join-Path $SourceRoot "tools\text\utf8_file_helpers.ps1")
...
"@ -NoNewline
    ...
    Write-Utf8File -Path (Join-Path $TargetRoot ".aiassistant\PROJECT.md") -Value @"
# Project Rules
...
Write-Host "Review SOCRATEX.md and run SocratexAI/tools/documents/audit_docs.ps1 when ready."
