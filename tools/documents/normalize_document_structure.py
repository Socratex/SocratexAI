...
import document_structure_normalizer_engine
from document_wrapper_helpers import repo_root, run_module_main


def main() -> int:
    parser = argparse.ArgumentParser(description="Normalize structured JSON documents to canonical shape.")
    ...
    return run_module_main(document_structure_normalizer_engine, argv)
