# Eval Prompt: Document Ownership
...
Evaluate whether the agent stores the idea in the right future-facing layer without duplicating it across every document or pretending it is shipped history.
